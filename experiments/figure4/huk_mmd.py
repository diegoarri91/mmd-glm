...
parser.add_argument('--lam_mmd', type=float, default=1e0)
...
lam_mmd, biased, lr, clip, n_batch_fr, num_epochs, initialization = args.lam_mmd, args.biased, args.lr, args.clip, args.n_batch_fr, args.num_epochs, args.initialization 
beta0, beta1 = args.beta0, args.beta1           
